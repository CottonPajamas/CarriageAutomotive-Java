...
<body background="${pageContext.request.contextPath}/image/whitepoly.jpg"/>
	<div style="min-height: 88%;position: relative;margin: 0;height: 50%;">
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				<div class="navbar-header">
					<a class="navbar-brand text-center" href="#">Carriage Automotive -
				...
				<sec:authorize access="isAuthenticated()">
					...
					<div class="nav navbar-nav navbar-right">
						<span class="btn btn-primary">Hi 
							...
							logged in as <sec:authentication property="principal.userRole" />.
						</span>
				...
				<div class="col-md-2 sidebar-offcanvas" id="sidebar"
					...
					<div class="sidebar-nav">
						<ul class="nav">
							...
							<li class="nav-divider"></li>
							<li><a class="btn btn-primary"
								href="/carriageautomotive/mechanic/product/browse">Browse Catalogue</a></li>
							<li class="nav-divider"></li>
	...
	<footer style="text-align: center;position: relative;bottom: 0;padding: 1rem;right: 0;left: 0;">
		<br />
		<hr />
		<p>
			&copy;
			...
			- Carriage Automotive Incorporated - Version 45.12
		</p>
	</footer>
</body>
</html>
